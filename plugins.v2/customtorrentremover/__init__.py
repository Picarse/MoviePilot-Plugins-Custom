...
class CustomTorrentRemover(_PluginBase):
    # 插件名称
    ...
    # 作者主页
    author_url = "https://github.com/Picarse/MoviePilot-Plugins-Custom"
    # 插件配置项ID前缀
    plugin_config_prefix = "customtorrentremover_"
    # 加载顺序
    plugin_order = 8
    # 可使用的用户级别
    auth_level = 2
